...
function App() {
  const [myTags1, setMyTags1] = useState<string[]>(["react", "typescript"]);
  ...
  return (
    <div className="container mx-auto p-4 space-y-8">
      <h1 className="text-3xl font-bold text-gray-800 mb-6">Tag Input</h1>
      ...
      <div className="bg-white p-6 rounded-lg shadow-md">
        <h2 className="text-xl font-semibold mb-4 text-gray-700">
          3. Tag Input with Custom Separator (semicolon ;)
        </h2>
        <TagInput
          initialTags={myTags3}
